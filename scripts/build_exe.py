...
def main() -> int:
    ...
    cmd = [
        ...
        "config.flow.mail",
        "--hidden-import",
        "config.flow.mail.actions",
        "--hidden-import",
        "config.flow.wrap_up",
        "--hidden-import",
        "config.flow.wrap_up.actions",
        "--hidden-import",
        "config.flow.handle_fail",
        "--hidden-import",
        "config.flow.handle_fail.actions",
        "--hidden-import",
        "config.flow.dang_qing_ge",
        "--hidden-import",
        "config.flow.dang_qing_ge.actions",
        "--collect-all",
        "customtkinter",
        str(ENTRY),
    ]
