...
def _priority_table() -> list[GeneralPriority]:
    ...
    from vision_bot.apps.ming_jiang_sha.qian_li_dan_qi.utils.priority import PRIORITY

    return PRIORITY


def _fallback_kind_order() -> tuple[RewardKind, ...]:
    from vision_bot.apps.ming_jiang_sha.qian_li_dan_qi.utils.priority import FALLBACK_KIND_ORDER

    return FALLBACK_KIND_ORDER


def _default_key_rewards() -> tuple[RewardKind, ...]:
    from vision_bot.apps.ming_jiang_sha.qian_li_dan_qi.utils.priority import DEFAULT_KEY_REWARDS
