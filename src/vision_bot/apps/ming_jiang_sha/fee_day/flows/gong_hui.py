...
def open_store(ctx) -> Result:
    return do(move().image(f"{_DIR}/gong-hui-store.png"), click())()


def wen_ding_ling(ctx) -> Result:
    return do(move().image(f"{_DIR}/wen_ding_ling.png"), click())()


def tian_ming_ling(ctx) -> Result:
    return do(move().image(f"{_DIR}/tian_ming_ling.png"), click())()


def tian_fa_ling(ctx) -> Result:
    return do(move().image(f"{_DIR}/tian_fa_ling.png"), click())()


def jun_ling_zhuang(ctx) -> Result:
    return do(move().image(f"{_DIR}/jun_ling_zhuang.png"), click())()
