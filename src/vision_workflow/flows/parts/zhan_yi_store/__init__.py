...
FLOW = Flow(
    ...
    modules=[
        ...
        Module(
            id="scroll",
            name="滑动商品列表",
            description="下滑商店列表以露出灵犀宝匣",
            event=scroll_store_list,
            on=_FULFILLED,
        ),
        Module(
            id="ling_xi-box",
            name="灵犀宝匣",
            description="选中灵犀宝匣商品",
            event=click_ling_xi_box,
            on=_CLICK,
        ),
        Module(
            id="max2",
