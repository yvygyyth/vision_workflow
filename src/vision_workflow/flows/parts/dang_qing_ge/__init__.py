...
FLOW = Flow(
    ...
    modules=[
        ...
        Module(id="space_close", name="空白关闭弹窗", description="点击空白处关闭领取结果弹窗", event=click_space_close, on=_CLICK),
        Module(id="close", name="关闭丹青阁", description="关闭界面返回主界面", event=click_close, on=_CLICK),
    ],
)
