...
FLOW = Flow(
    ...
    modules=[
        ...
        Module(id="space_click", name="空白关闭弹窗", description="点击空白处关闭领取结果弹窗", event=click_space_close, on=_CLICK),
        Module(id="email_close", name="关闭邮箱", description="关闭邮箱界面返回主界面", event=click_email_close, on=_CLICK),
    ],
)
