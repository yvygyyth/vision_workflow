...
FLOW = Flow(
    ...
    modules=[
        ...
        Module(id="buy_0", name="0 购买", description="点击 0 购买", event=click_0buy, on=_CLICK),
        ...
        Module(id="buy_500", name="500 购买", description="点击 500 购买", event=click_500buy, on=_CLICK),
        ...
        Module(id="buy_200", name="200 购买", description="点击 200 购买", event=click_200buy, on=_CLICK),
