...
FLOW = Flow(
    ...
    entry="entry_icon",
    modules=[
        Module(id="entry_icon", name="打开巴清商店", description="点击入口图标", event=click_entry_icon, on=_CLICK),
        ...
        Module(id="buy_0", name="0 购买", description="点击 0 购买", event=confirm, on=_CLICK),
